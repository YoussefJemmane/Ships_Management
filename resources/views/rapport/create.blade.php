            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <section>
                        ...
                        <form method="post" action="{{ route('rapport') }}" class="mt-6 space-y-6">
                            @csrf
                            ...
                            <div class="flex justify-around">
                                <div class="w-full pr-3">
                                    ...
                                    <x-text-input id="date_rapport" name="date_rapport" type="date"
                                        class="mt-1 block w-full" :value="old('date_rapport')" required autofocus
                                ...
                                <div class="w-full">
                                    ...
                                    <x-text-input id="shift" name="shift" type="text"
                                        class="mt-1 block w-full" min="1" max="3" :value="old('shift')" required autofocus
                                        autocomplete="shift" />
