        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <section>
                        <form method="post" action="{{ route('personnel.store') }}" class="mt-6 space-y-6">
                            @csrf

                            <div>
                                <x-input-label for="matricule" :value="__('Matricule')" />
                                <x-text-input id="matricule" name="matricule" type="text" class="mt-1 block w-full"
                                    :value="old('matricule')" required autofocus autocomplete="matricule" />
                            ...
                            <div class="w-full">
                                ...
                                <x-text-input id="fonction" name="fonction" type="text" class="mt-1 block w-full"
                                    :value="old('fonction')" required autofocus autocomplete="fonction" />
                            ...
                            <div class="flex justify-around">
                                ...
                                <div class="w-full pr-3">
                                    ...
                                    <x-text-input id="heure_debut_affectation" name="heure_debut_affectation" type="time"
                                        class="mt-1 block w-full" min="1" max="3" :value="old('heure_debut_affectation')" required
