                    ...
                    <section>
                        <header class="flex justify-end">
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                This Navire is Created by {{ Auth::user()->name }}
                            </p>
                        </header>
                            ...
                            <div class="flex justify-around">
                                <div class="w-full pr-3">
                                    ...
                                    <x-text-input id="imo" name="imo" type="text" class="mt-1 block w-full"
                                        :value="old('imo')" required autofocus autocomplete="imo" />
                                ...
                                <div class="w-full">
                                    ...
                                    <x-text-input id="l_o_a" name="l_o_a" type="text" class="mt-1 block w-full"
                                        :value="old('l_o_a')" required autofocus autocomplete="l_o_a" />
                            ...
                            <div class="flex justify-around">
                                <div class="w-full pr-3">
                                    ...
                                    <x-text-input id="t_p_l" name="t_p_l" type="text" class="mt-1 block w-full"
                                        :value="old('t_p_l')" required autofocus autocomplete="t_p_l" />
                                ...
                                <div class="w-full">
                                    ...
                                    <x-text-input id="tirant_eau" name="tirant_eau" type="text" class="mt-1 block w-full"
                                        :value="old('tirant_eau')" required autofocus autocomplete="tirant_eau" />
                            ...
                            <div class="flex justify-around">
                                <div class="w-full pr-3">
                                    ...
                                    <x-text-input id="jauge_brute" name="jauge_brute" type="text"
                                        class="mt-1 block w-full" :value="old('jauge_brute')" required autofocus
                                ...
                                <div class="w-full">
                                    ...
                                    <x-text-input id="jauge_net" name="jauge_net" type="text" class="mt-1 block w-full"
                                        :value="old('jauge_net')" required autofocus autocomplete="jauge_net" />
                            ...
                            <div class="flex justify-around">
                                <div class="w-full pr-3">
                                    ...
                                    <x-text-input id="pavillon" name="pavillon" type="text" class="mt-1 block w-full"
                                        :value="old('pavillon')" required autofocus autocomplete="pavillon" />
                                ...
                                <div class="w-full ">
                                    ...
                                    <x-text-input id="provenance" name="provenance" type="text" class="mt-1 block w-full"
                                        :value="old('provenance')" required autofocus autocomplete="provenance" />
                            ...
                            <div class="flex justify-around">
                                <div class="w-full pr-3">
                                    ...
                                    <x-text-input id="tirant_eau_entree_avant" name="tirant_eau_entree_avant" type="text"
                                        class="mt-1 block w-full" :value="old('tirant_eau_entree_avant')" required autofocus
                                ...
                                <div class="w-full ">
                                    ...
                                    <x-text-input id="tirant_eau_entree_arriere" name="tirant_eau_entree_arriere"
                                        type="text" class="mt-1 block w-full" :value="old('tirant_eau_entree_arriere')" required autofocus
                            ...
                            <div class="flex justify-around">
                                <div class="w-full pr-3">
                                    ...
                                    <x-text-input id="armateur" name="armateur" type="text"
                                        class="mt-1 block w-full" :value="old('armateur')" required autofocus
                                ...
                                <div class="w-full ">
                                    ...
                                    <x-text-input id="armateur_disposant" name="armateur_disposant" type="text"
                                        class="mt-1 block w-full" :value="old('armateur_disposant')" required autofocus
                            ...
                            <div class="flex justify-around">
                                <div class="w-full pr-3">
                                    ...
                                    <x-text-input id="operateur" name="operateur" type="text"
                                        class="mt-1 block w-full" :value="old('operateur')" required autofocus
                                ...
                                <div class="w-full ">
                                    ...
                                    <x-text-input id="numero_escale" name="numero_escale" type="text"
                                        class="mt-1 block w-full" :value="old('numero_escale')" required autofocus
                            ...
                            <div class="flex justify-around">
                                <div class="w-full pr-3">
                                    ...
                                    <x-text-input id="date_accostage" name="date_accostage" type="date"
                                        class="mt-1 block w-full" :value="old('date_accostage')" required autofocus
                                ...
                                <div class="w-full ">
                                    ...
                                    <x-text-input id="date_appareillage" name="date_appareillage" type="date"
                                        class="mt-1 block w-full" :value="old('date_appareillage')"  autofocus
                            ...
                            <div class="flex justify-around">
                                <div class="w-full pr-3">
                                    ...
                                    <x-text-input id="date_debut_travail" name="date_debut_travail" type="date"
                                        class="mt-1 block w-full" :value="old('date_debut_travail')" required autofocus
                                ...
                                <div class="w-full ">
                                    ...
                                    <x-text-input id="date_fin_travail" name="date_fin_travail" type="date"
                                        class="mt-1 block w-full" :value="old('date_fin_travail')" required autofocus
